...
?>
<p><span id="ewPageCaption" class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Delete") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $user->TableCaption() ?></span></p>
...
?>
<form name="fuserdelete" id="fuserdelete" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<br>
...
<?php echo $user->TableCustomInnerHtml ?>
	...
	<tr class="ewTableHeader">
		<td><span id="elh_user_id_user" class="user_id_user"><table class="ewTableHeaderBtn"><tr><td><?php echo $user->id_user->FldCaption() ?></td></tr></table></span></td>
		<td><span id="elh_user__email" class="user__email"><table class="ewTableHeaderBtn"><tr><td><?php echo $user->_email->FldCaption() ?></td></tr></table></span></td>
		<td><span id="elh_user_name" class="user_name"><table class="ewTableHeaderBtn"><tr><td><?php echo $user->name->FldCaption() ?></td></tr></table></span></td>
		<td><span id="elh_user_surname" class="user_surname"><table class="ewTableHeaderBtn"><tr><td><?php echo $user->surname->FldCaption() ?></td></tr></table></span></td>
		<td><span id="elh_user_timestamp" class="user_timestamp"><table class="ewTableHeaderBtn"><tr><td><?php echo $user->timestamp->FldCaption() ?></td></tr></table></span></td>
		<td><span id="elh_user_fbid" class="user_fbid"><table class="ewTableHeaderBtn"><tr><td><?php echo $user->fbid->FldCaption() ?></td></tr></table></span></td>
		<td><span id="elh_user_gid" class="user_gid"><table class="ewTableHeaderBtn"><tr><td><?php echo $user->gid->FldCaption() ?></td></tr></table></span></td>
	</tr>
	</thead>
	<tbody>
<?php
...
?>
	<tr<?php echo $user->RowAttributes() ?>>
		<td<?php echo $user->id_user->CellAttributes() ?>><span id="el<?php echo $user_delete->RowCnt ?>_user_id_user" class="user_id_user">
<span<?php echo $user->id_user->ViewAttributes() ?>>
<?php echo $user->id_user->ListViewValue() ?></span>
</span></td>
		<td<?php echo $user->_email->CellAttributes() ?>><span id="el<?php echo $user_delete->RowCnt ?>_user__email" class="user__email">
<span<?php echo $user->_email->ViewAttributes() ?>>
<?php echo $user->_email->ListViewValue() ?></span>
</span></td>
		<td<?php echo $user->name->CellAttributes() ?>><span id="el<?php echo $user_delete->RowCnt ?>_user_name" class="user_name">
<span<?php echo $user->name->ViewAttributes() ?>>
<?php echo $user->name->ListViewValue() ?></span>
</span></td>
		<td<?php echo $user->surname->CellAttributes() ?>><span id="el<?php echo $user_delete->RowCnt ?>_user_surname" class="user_surname">
<span<?php echo $user->surname->ViewAttributes() ?>>
<?php echo $user->surname->ListViewValue() ?></span>
</span></td>
		<td<?php echo $user->timestamp->CellAttributes() ?>><span id="el<?php echo $user_delete->RowCnt ?>_user_timestamp" class="user_timestamp">
<span<?php echo $user->timestamp->ViewAttributes() ?>>
<?php echo $user->timestamp->ListViewValue() ?></span>
</span></td>
		<td<?php echo $user->fbid->CellAttributes() ?>><span id="el<?php echo $user_delete->RowCnt ?>_user_fbid" class="user_fbid">
<span<?php echo $user->fbid->ViewAttributes() ?>>
<?php echo $user->fbid->ListViewValue() ?></span>
</span></td>
		<td<?php echo $user->gid->CellAttributes() ?>><span id="el<?php echo $user_delete->RowCnt ?>_user_gid" class="user_gid">
