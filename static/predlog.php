			...
			<div class="span9">
				<div class="navigation">
					...
					<div class="navblock 5">
						<a href="/pravica-do-cloveku-prijazne-ekonomije?sort=imp&w=desc">PRAVICA DO ČLOVEKU PRIJAZNE EKONOMIJE</a>
					</div>
					<div class="divider">
					</div>
					<div class="navblock 4">
						<a href="/pravica-do-narave?sort=imp&w=desc">PRAVICA (DO) NARAVE</a>
					</div>
					<div class="divider">
					</div>
					<div class="navblock 3">
						<a href="/pravica-do-dobre-politicne-oblasti?sort=imp&w=desc">PRAVICA DO DOBRE POLITIČNE OBLASTI</a>
					</div>
					<div class="divider">
					</div>
					<div class="navblock 2">
						<a href="/pravica-do-skupnega?sort=imp&w=desc">PRAVICA DO SKUPNEGA</a>
					</div>
					<div class="divider">
					</div>
					<div class="navblock 1">
						<a href="/pravica-do-dobrega-zivljenja-in-solidarne-druzbe?sort=imp&w=desc">PRAVICA DO DOBREGA ŽIVLJENJA IN SOLIDARNE DRUŽBE</a>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="row">
					...
					<div class="span6">
						<div class="argumentboxfor">
							...
							<div class="argumentvotesplus"><span><?php print $value->users_plus; ?></span></div>
							<div class="argumentdown  <?php print ($value->vuser_minus>0) ? "marked" : null; ?>" data-id="<?php print $value->id_argument; ?>"></div>
							<div class="argumentvotesminus"><span><?php print $value->users_minus; ?></span></div>
